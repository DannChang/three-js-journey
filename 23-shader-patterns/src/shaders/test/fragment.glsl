...
void main()
{
    ...
    // //Pattern 26 - Left corner gradient
    // float strength = length(vUv);

    // //Pattern 27 - Center gradient
    // float strength = distance(vUv, vec2(0.5));

    // //Pattern 28 - Inverse center gradient
    // float strength = 1.0 - distance(vUv, vec2(0.5));

    // //Pattern 29 - Reverse gradient (Star)
    // float strength = 0.015 / distance(vUv, vec2(0.5));

    // //Pattern 30 - Wider light reverse gradient (Star)
    // vec2 lightUv = vec2(
    //     vUv.x * 0.1 + 0.45,
    //     vUv.y * 0.5 + 0.25
    // );
    ...
    // //Pattern 31 - Star shape gradient
    ...
    // //Pattern 32 - diagonal Star shape gradient (rotation funciton needed)
    ...
    // // Pattern 33 - Circle in square
    // float strength = step(0.25, distance(vUv, vec2(0.5)));

    // // Pattern 34 - Gradient Circle in square
    // float strength = abs((0.25, distance(vUv, vec2(0.5))) - 0.25);

    // // Pattern 35 - Hollow dark circle white square
    // float strength = step(0.01, abs(distance(vUv, vec2(0.5)) - 0.25));

    // // Pattern 36 - Inverse of Hollow dark circle white square
    // float strength = 1.0 - step(0.01, abs(distance(vUv, vec2(0.5)) - 0.25));

    // // Pattern 37 - Wavy Hollow Circle
    // vec2 wavedUv = vec2(
    //     vUv.x,
    ...
    // // Pattern 39 - CPU chip wavy Circle
    // vec2 wavedUv = vec2(
    ...
    // //Pattern 41 - Offset Angled gradient
    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5);
    // float strength = angle;

    // //Pattern 42 - Clock gradient (Angle from 0.5 - 1.0)
    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5);
    // angle /= 2.0 * PI;
    // angle += 0.5;
    // float strength = angle;

    // //Pattern 43 - Multiple angled petal
    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5);
    // angle /= 2.0 * PI;
    // angle += 0.5;
    // angle *= 20.0;
    ...
    // //Pattern 44 - Inverse of Multiple angled petal
    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5);
    // angle /= 2.0 * PI;
    // angle += 0.5;
    // float strength = sin(angle * 100.0);

    // //Pattern 45 - Evenly wavy circle
    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5);
    // angle /= 2.0 * PI;
    // angle += 0.5;
    ...
    // //Pattern 46 - Perlin Noise shape
    // float strength = cnoise(vUv * 10.0);

    // //Pattern 47 - Reverse Perlin Noise shape
    // float strength = step(0.0, cnoise(vUv * 10.0));

    // //Pattern 48 - Inverse of Perlin Noise shape
