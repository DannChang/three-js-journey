...
doorLight.position.set(0, 4.8, 2.7)
house.add(doorLight)
...
renderer.setSize(sizes.width, sizes.height)
renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2))
renderer.setClearColor('#262837') // Hides edges of plane
